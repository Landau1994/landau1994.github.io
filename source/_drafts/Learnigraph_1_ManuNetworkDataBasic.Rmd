...
*Learn-igraph*系列是对[Statistical Analysis of Network Data with R](https://link.springer.com/book/10.1007/978-1-4939-0983-4)一书的学习笔记，介绍如何使用R进行网络数据分析，网络数据的处理主要是基于`igraph`包，可视化用的是`ggnet`
...
+ simple-graph: 可以用`is.simple()`判定，可以用`simplify()`将`multi-graph`转换为`simple-graph`.
